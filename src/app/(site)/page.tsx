    ...
    <>
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relatve">
        ...
        <TitleSection
          ...
          subheading="Capture your ideas, thoughts, and meeting notes in a structured and oranized manner"
          pill="Features"
        />
                  ...
                  <div className="flex items-center gap-4">
                    <Avatar>
                      ...
                      <div>
                        ...
                        <CardDescription className="dark:text-washed-purple-800">{testimonial.name.toLocaleUpperCase()}</CardDescription>
                      </div>
                  </div>
                }
                cardContent={
